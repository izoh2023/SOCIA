...
const Page = () => {
  ...
  useEffect(() => {
    const getData = async () => {
      try {
        const res = await fetch('https://socia-isaacs-projects-f16c4db6.vercel.app/restAPI')
...
const handleDelete = async () => {
  try {
    const ApiResponse = await fetch('https://socia-isaacs-projects-f16c4db6.vercel.app/restAPI',{
      method: 'DELETE',
      headers: {'Content-Type': 'application/json'},
      body: JSON.stringify(data)
